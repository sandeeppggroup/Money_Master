...
import 'package:money_master/screens/transaction/transactionlist_view.dart';
import 'package:money_master/search/search.dart';
          ...
          return Theme(
            data: Theme.of(context).copyWith(
              colorScheme: const ColorScheme.light(
                primary: Color.fromARGB(213, 20, 27, 38),
                onPrimary: Colors.white,
                onSurface: Color.fromARGB(213, 20, 27, 38),
              ),
            ),
            child: child!,
          );
